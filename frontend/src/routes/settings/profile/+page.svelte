...
<div class="max-w-xl">
	...
	<div class="mb-8">
		...
		<p class="text-xs text-muted-foreground mb-4">Actions usage is capped at 1,500 minutes per month for your account. When the limit is reached, workflows stop running until the next month.</p>
